 ...
 * 
 * Creates a test moderator account or upgrades an existing user to moderator role
 * 
 * Usage:
 *   node create-test-moderator.js [email]
 * 
 * If email is provided, upgrades that user to moderator role
 * Otherwise, creates a new test moderator account
 */
