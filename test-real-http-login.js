// Test HTTP login with real user credentials
...
console.log('Testing HTTP login with real user credentials...');

async function testRealHttpLogin() {
  try {
    ...
    console.log('6. Testing the login endpoint with real credentials...');
    setTimeout(async () => {
      try {
        ...
        server.close();
        await pool.end();
        console.log('✅ HTTP login test with real credentials completed successfully!');
